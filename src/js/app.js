...
App.listenForEvents();
  ...
  addcandi: function(){
    ...
    var name = document.getElementById("cand_name").value;
    var roll = document.getElementById("cand_roll").value;
    var cPost = document.getElementById("candpost").value;
    App.contracts.Election.deployed().then(function(instance) {
      return instance.addCandidate(name, roll, cPost, { from: App.account });
